...
@TableName("apply_open_model")
@ApiModel(value = "对象", description = "", parent = BaseEntity.class)
public class OpenModel extends BaseEntity {
    ...
    @ApiModelProperty(value = "自动发布1是，0否", dataType = "Integer", example = "1")
    ...
    @ApiModelProperty(value = "部门间转办1是，0否", dataType = "Integer", example = "1")
    ...
    @ApiModelProperty(value = "表单模板", dataType = "String")
    @TableField("form_templet")
    private String formTemplet;

    @ApiModelProperty(value = "列表模板", dataType = "String")
    @TableField("list_templet")
    private String listTemplet;

    @ApiModelProperty(value = "正文模板", dataType = "String")
    @TableField("view_templet")
    private String viewTemplet;

    @ApiModelProperty(value = "打印模板后台用", dataType = "String")
