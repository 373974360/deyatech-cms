...
public class StationGroupUserController extends BaseController {
    ...
    @ApiOperation(value="单个保存或者更新站点用户关联", notes="根据站点用户关联对象保存或者更新站点用户关联信息")
    @ApiImplicitParam(name = "stationGroupUser", value = "站点用户关联对象", required = true, dataType = "StationGroupUser", paramType = "query")
    public RestResult<Boolean> saveOrUpdate(StationGroupUser stationGroupUser) {
        log.info(String.format("保存或者更新站点用户关联: %s ", JSONUtil.toJsonStr(stationGroupUser)));
    ...
    @ApiOperation(value="批量保存或者更新站点用户关联", notes="根据站点用户关联对象集合批量保存或者更新站点用户关联信息")
    @ApiImplicitParam(name = "stationGroupUserList", value = "站点用户关联对象集合", required = true, allowMultiple = true, dataType = "StationGroupUser", paramType = "query")
    public RestResult<Boolean> saveOrUpdateBatch(Collection<StationGroupUser> stationGroupUserList) {
        log.info(String.format("批量保存或者更新站点用户关联: %s ", JSONUtil.toJsonStr(stationGroupUserList)));
        boolean result = stationGroupUserService.saveOrUpdateBatch(stationGroupUserList);
        return RestResult.ok(result);
    }

    /**
     * 根据StationGroupUser对象属性逻辑删除站点用户关联
     *
     * @param stationGroupUser
     * @return
     */
    @PostMapping("/removeByStationGroupUser")
    @ApiOperation(value="根据StationGroupUser对象属性逻辑删除站点用户关联", notes="根据站点用户关联对象逻辑删除站点用户关联信息")
    @ApiImplicitParam(name = "stationGroupUser", value = "站点用户关联对象", required = true, dataType = "StationGroupUser", paramType = "query")
    public RestResult<Boolean> removeByStationGroupUser(StationGroupUser stationGroupUser) {
        log.info(String.format("根据StationGroupUser对象属性逻辑删除站点用户关联: %s ", stationGroupUser));
    ...
    @ApiOperation(value="根据ID批量逻辑删除站点用户关联", notes="根据站点用户关联对象ID批量逻辑删除站点用户关联信息")
    @ApiImplicitParam(name = "ids", value = "站点用户关联对象ID集合", required = true, allowMultiple = true, dataType = "Serializable", paramType = "query")
    public RestResult<Boolean> removeByIds(@RequestParam("ids[]") List<String> ids) {
        log.info(String.format("根据id批量删除站点用户关联: %s ", JSONUtil.toJsonStr(ids)));
        boolean result = stationGroupUserService.removeByIds(ids);
        return RestResult.ok(result);
    }

    /**
     * 根据StationGroupUser对象属性获取站点用户关联
     *
     * @param stationGroupUser
     * @return
     */
    @GetMapping("/getByStationGroupUser")
    @ApiOperation(value="根据StationGroupUser对象属性获取站点用户关联", notes="根据站点用户关联对象属性获取站点用户关联信息")
    @ApiImplicitParam(name = "stationGroupUser", value = "站点用户关联对象", required = false, dataType = "StationGroupUser", paramType = "query")
    public RestResult<StationGroupUserVo> getByStationGroupUser(StationGroupUser stationGroupUser) {
        ...
        log.info(String.format("根据id获取站点用户关联：%s", JSONUtil.toJsonStr(stationGroupUserVo)));
        return RestResult.ok(stationGroupUserVo);
    }

    /**
     * 根据StationGroupUser对象属性检索所有站点用户关联
     *
     * @param stationGroupUser
     * @return
     */
    @GetMapping("/listByStationGroupUser")
    @ApiOperation(value="根据StationGroupUser对象属性检索所有站点用户关联", notes="根据StationGroupUser对象属性检索所有站点用户关联信息")
    @ApiImplicitParam(name = "stationGroupUser", value = "站点用户关联对象", required = false, dataType = "StationGroupUser", paramType = "query")
    public RestResult<Collection<StationGroupUserVo>> listByStationGroupUser(StationGroupUser stationGroupUser) {
        ...
        log.info(String.format("根据StationGroupUser对象属性检索所有站点用户关联: %s ",JSONUtil.toJsonStr(stationGroupUserVos)));
        return RestResult.ok(stationGroupUserVos);
    }

    /**
     * 根据StationGroupUser对象属性分页检索站点用户关联
     *
     * @param stationGroupUser
     * @return
     */
    @GetMapping("/pageByStationGroupUser")
    @ApiOperation(value="根据StationGroupUser对象属性分页检索站点用户关联", notes="根据StationGroupUser对象属性分页检索站点用户关联信息")
    @ApiImplicitParam(name = "stationGroupUser", value = "站点用户关联对象", required = false, dataType = "StationGroupUser", paramType = "query")
    public RestResult<IPage<StationGroupUserVo>> pageByStationGroupUser(StationGroupUser stationGroupUser) {
        ...
        log.info(String.format("根据StationGroupUser对象属性分页检索站点用户关联: %s ",JSONUtil.toJsonStr(stationGroupUsers)));
    ...
    @ApiOperation(value = "检索站点关联的所有用户信息", notes = "检索站点关联的所有用户信息")
    @ApiImplicitParam(name = "stationGroupUserVo", value = "站点用户", required = false, dataType = "StationGroupUserVo", paramType = "query")
    ...
    @ApiOperation(value = "设置用户站点", notes = "设置用户站点")
    @ApiImplicitParams({
